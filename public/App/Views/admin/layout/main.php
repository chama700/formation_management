...
<div class="flex">
    ...
    <div class="w-64 min-h-screen bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-1 px-4 py-4 space-y-2">
            ...
            <a href="/admin/trainer" class="block py-2 px-3 rounded hover:bg-gray-700">👨‍🏫 Formateurs</a>
            <a href="/admin/discipline" class="block py-2 px-3 rounded hover:bg-gray-700">📚 Disciplines</a>
            <a href="/admin/subject" class="block py-2 px-3 rounded hover:bg-gray-700">📖 Sujets</a>
            <a href="/admin/course" class="block py-2 px-3 rounded hover:bg-gray-700">🎓 Cours</a>
            <a href="/admin/formation" class="block py-2 px-3 rounded hover:bg-gray-700">📆 Formations</a>
        </nav>
    </div>
    <!-- Main content -->
